...
**
** Created: Sat Oct 27 21:59:11 2012
...
static const char qt_meta_stringdata_Graph[] = {
    "Graph\0\0data\0setData(QVector<QPointF>)\0"
};
...
void Graph::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->setData((*reinterpret_cast< QVector<QPointF>(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *Graph::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsItem"))
        return static_cast< QGraphicsItem*>(const_cast< Graph*>(this));
