...
# Generated by qmake (2.01a) (Qt 4.8.2) on: Thu Oct 25 12:23:55 2012
# Project:  eviewer.pro
# Template: app
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_DECLARATIVE_DEBUG -DQT_NO_DEBUG -DQT_DECLARATIVE_LIB -DQT_GUI_LIB -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -pipe -O2 -Wall -W -D_REENTRANT $(DEFINES)
CXXFLAGS      = -pipe -O2 -Wall -W -D_REENTRANT $(DEFINES)
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtDeclarative -I/usr/include/qt4 -I.
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib64/qt4 -lQtDeclarative -L/usr/lib64 -L/usr/lib64/qt4 -lQtScript -lQtSvg -L/usr/X11R6/lib -lQtSql -lQtXmlPatterns -lQtNetwork -lQtGui -lQtCore -lgthread-2.0 -lrt -lglib-2.0 -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
SOURCES       = main.cpp \
		...
		settingsdock.cpp \
		declarativeview.cpp moc_mainwindow.cpp \
		moc_statusbar.cpp \
		moc_toolbar.cpp \
		moc_menubar.cpp \
		moc_infodock.cpp \
		moc_declarativeview.cpp \
		qrc_res.cpp
OBJECTS       = main.o \
		mainwindow.o \
		statusbar.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/eviewer1.0.0/ && $(COPY_FILE) --parents mainwindow.h statusbar.h toolbar.h menubar.h infodock.h groupfiltersdock.h settingsdock.h declarativeview.h .tmp/eviewer1.0.0/ && $(COPY_FILE) --parents res.qrc .tmp/eviewer1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp statusbar.cpp toolbar.cpp menubar.cpp infodock.cpp groupfiltersdock.cpp settingsdock.cpp declarativeview.cpp .tmp/eviewer1.0.0/ && (cd `dirname .tmp/eviewer1.0.0` && $(TAR) eviewer1.0.0.tar eviewer1.0.0 && $(COMPRESS) eviewer1.0.0.tar) && $(MOVE) `dirname .tmp/eviewer1.0.0`/eviewer1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/eviewer1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_statusbar.cpp moc_toolbar.cpp moc_menubar.cpp moc_infodock.cpp moc_declarativeview.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_statusbar.cpp moc_toolbar.cpp moc_menubar.cpp moc_infodock.cpp moc_declarativeview.cpp
...
moc_declarativeview.cpp: declarativeview.h
	/usr/bin/moc $(DEFINES) $(INCPATH) declarativeview.h -o moc_declarativeview.cpp
...
declarativeview.o: declarativeview.cpp declarativeview.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o declarativeview.o declarativeview.cpp
...
moc_declarativeview.o: moc_declarativeview.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_declarativeview.o moc_declarativeview.cpp
